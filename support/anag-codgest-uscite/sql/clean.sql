...
classificato as (
    select
        ...
        case
            ...
            when b.descrizione_codice ilike '%trasferimenti in conto capitale%'
                 or b.descrizione_codice ilike '%conto capitale%' then 'Trasferimenti c/capitale'
            ...
            when b.descrizione_codice ilike '%imposte%' or b.descrizione_codice ilike '%tasse%'
                 ...
                 or regexp_matches(b.descrizione_codice, '(?i)\biva\b') then 'Imposte e tasse'
